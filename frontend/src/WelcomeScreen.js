...
import { Modal, Button, Text, Input, Row, Checkbox, useInput } from "@nextui-org/react";
        ...
        <div style={{ position: 'relative', width: '100vw', height: '100vh' }}>
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <Button auto color="secondary" onClick={SignUp} > Sign Up
                    </Button>
                </Modal.Footer>
            </Modal>
            ...
            >
                <Modal.Body>
                    <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_rbtawnwz.json" background="transparent" speed="1" style={{ width: '300px', height: '300px' }} autoplay></lottie-player>
                </Modal.Body>
            </Modal>
        </div>
    )
